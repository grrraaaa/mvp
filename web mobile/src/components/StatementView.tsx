...
import { BankAccount, BankDocument, StatementFilter } from '../types';
              ...
              <button
                ...
                className={`py-3.5 px-4 focus:outline-none transition-all uppercase tracking-wide border-b-2 font-black ${
                  isSel 
                    ...
                    : 'border-transparent text-gray-550 hover:text-sber-green'
                }`}
              >
                {tab.label}
              </button>
        ...
        <div className="p-6 space-y-6">
          ...
          {activeSubTab === 'accounts' ? (
            <>
              ...
              <div className="bg-[#f8fafc]/80 border border-gray-150 rounded-xl p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full border border-gray-300 rounded-lg p-2.5 text-xs font-semibold bg-white text-gray-750 focus:ring-sber-green focus:ring-1 focus:border-sber-green"
                      >
                ...
                <div className="flex flex-wrap items-center gap-6 text-xs font-medium pt-2 border-t border-gray-150/55 text-gray-600">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <input 
                      ...
                      className="rounded border-gray-300 text-sber-green focus:ring-sber-green h-4 w-4"
                    />
                ...
                <div className="flex justify-end pt-2">
                  <button
                    ...
                    disabled={isLoading}
                    className="bg-sber-green hover:bg-sber-green-hover text-white px-8 py-3 rounded-lg text-xs font-black shadow-sm disabled:bg-gray-200 transition-all active:scale-[0.98] flex items-center gap-2 text-center"
                  >
              ...
              {isLoading && (
                <div className="p-12 text-center flex flex-col items-center justify-center gap-3 animate-pulse bg-slate-50 rounded-xl border">
                  <RefreshCw className="w-8 h-8 text-sber-green animate-spin" />
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="bg-slate-50 border border-gray-150 p-6 rounded-xl space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs font-medium">
                      ...
                      <div className="bg-white p-3.5 border rounded-xl border-sber-green/40 bg-emerald-50/15">
            ...
            <div className="p-16 text-center space-y-3.5 bg-slate-50 rounded-xl border border-dashed text-gray-400 font-medium">
              <AlertCircle className="w-8 h-8 text-sber-green mx-auto animate-pulse" />
